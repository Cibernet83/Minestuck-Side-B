package com.cibernet.fetchmodiplus.client.gui.captchalogue;
...
public class JujuGuiHandler extends BaseModusGuiHandler
{
	...
	protected void actionPerformed(GuiButton button) throws IOException
	{
		...
		{
			FMPChannelHandler.sendToServer(FMPPacket.makePacket(FMPPacket.Type.JUJU_UPDATE, link ? JujuModusPacket.Type.LINK : JujuModusPacket.Type.UNLINK));
		}
