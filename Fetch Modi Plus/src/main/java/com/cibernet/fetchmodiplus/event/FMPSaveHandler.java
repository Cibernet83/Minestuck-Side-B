...
public class FMPSaveHandler
{
	...
	public void onWorldSave(WorldEvent.Save event)
	{
		...
		File dataFile = event.getWorld().getSaveHandler().getMapFileFromName("FetchModiPlusData");
		if (dataFile != null)
		{
	...
	public void onWorldLoad(WorldEvent.Load event)
	{
		...
		File dataFile = saveHandler.getMapFileFromName("FetchModiPlusData");
