...
public class RequestModusUpdatePacket extends FMPPacket
{
	...
	public void execute(EntityPlayer player)
	{
		...
		if(player != null)
			FMPChannelHandler.sendToPlayer(FMPPacket.makePacket(Type.UPDATE_MODUS, CaptchaDeckHandler.writeToNBT(MinestuckPlayerData.getData(target).modus)), player);
	}
