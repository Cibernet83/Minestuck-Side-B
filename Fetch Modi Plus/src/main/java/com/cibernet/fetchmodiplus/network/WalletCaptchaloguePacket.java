...
import com.cibernet.fetchmodiplus.items.WalletEntityItem;
import com.cibernet.fetchmodiplus.registries.FMPItems;
import com.cibernet.minestuckuniverse.items.ItemSpaceSalt;
...
public class WalletCaptchaloguePacket extends FMPPacket
{
    int entity;
    BlockPos pos;
    ...
    public void execute(EntityPlayer player)
    {
        ...
        if(entity != null)
        {
            ItemStack stack = new ItemStack(FMPItems.walletEntityItem);
