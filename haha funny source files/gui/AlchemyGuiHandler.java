...
public class AlchemyGuiHandler extends BaseModusGuiHandler implements IGristSelectable
{
	...
	public void drawScreen(int xcor, int ycor, float f)
	{
		...
		this.guiButton.grist = ((AlchemyModus)modus).getWildcardGrist();
		this.guiButton.displayString = I18n.format("gui.alchemyWildcard", MinestuckConfig.alchemyIcons ? "" : guiButton.grist.getDisplayName());
	...
	{
		public Grist grist = MinestuckGrists.build;
		...
		public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
		{
			...
			Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation(grist.getIcon().getResourceDomain(), "textures/grist/" + grist.getIcon().getResourcePath()+ ".png"));
