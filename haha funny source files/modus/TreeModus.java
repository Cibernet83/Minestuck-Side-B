	...
	public void setValue(byte type, int value)
	{
		...
		if(autobalance)
		{
			...
			if(node != this.node && player != null)
				MinestuckChannelHandler.sendToPlayer(MinestuckPacket.makePacket(MinestuckPacket.Type.CAPTCHA, PacketCaptchaDeck.DATA, SylladexUtils.writeToNBT(this)), player);
		}
	}
