...
public class AlchemyModus extends Modus
{
	
	public Grist wildcardGrist = MinestuckGrists.build;
	...
	public GristSet getGristCost(ItemStack stack)
	{
		...
		if(stack.getItem() == MinestuckItems.eightBall)
			set = new GristSet(new Grist[] {MinestuckGrists.build, MinestuckGrists.artifact, MinestuckGrists.cobalt, MinestuckGrists.zillium, MinestuckGrists.mercury}, new int[] {1000, 100, 800, 2, 800});
	...
	public Grist getWildcardGrist()
	{
		return wildcardGrist;
	}
	
	public AlchemyModus setWildcardGrist(Grist grist)
	{
	...
	public void readFromNBT(NBTTagCompound nbt)
	{
		...
		wildcardGrist = Grist.REGISTRY.getValue(nbt.getInteger("WildcardGrist"));
		if(wildcardGrist == null)
			wildcardGrist = MinestuckGrists.build;
	}
	
	@Override
	public NBTTagCompound writeToNBT(NBTTagCompound nbt)
	{
		nbt.setInteger("WildcardGrist", Grist.REGISTRY.getID(wildcardGrist));
