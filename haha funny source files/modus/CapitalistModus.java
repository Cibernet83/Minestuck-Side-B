...
import com.mraof.minestuck.client.gui.captchalogue.CapitalistGuiHandler;
...
public class CapitalistModus extends Modus
{
	...
	public static int getItemPrice(ItemStack stack)
	{
		...
		for(Map.Entry<Grist, Integer> grist : gristConversion.gristTypes.entrySet())
