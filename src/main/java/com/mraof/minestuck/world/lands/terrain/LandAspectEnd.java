...
public class LandAspectEnd extends TerrainLandAspect
{
	...
	public List<ILandDecorator> getDecorators()
	{
		...
		list.add(new WorldgenTreeDecorator(2, new WorldGenEndTree(false), MinestuckBiomes.mediumRough));
		list.add(new WorldgenTreeDecorator(3, new WorldGenEndTree(false), MinestuckBiomes.mediumNormal));
