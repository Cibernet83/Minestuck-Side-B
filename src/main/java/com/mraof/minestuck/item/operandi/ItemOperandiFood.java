...
public class ItemOperandiFood extends ItemFood
{
	private final EnumAction action;
	
	public ItemOperandiFood(String name, int amount, float saturation)
	{
		this(name, amount, saturation, EnumAction.EAT);
	}
	public ItemOperandiFood(String name, int amount, float saturation, EnumAction action)
	{
