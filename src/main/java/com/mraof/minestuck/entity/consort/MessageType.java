...
public abstract class MessageType
{
	...
	public static class ItemRequirement extends MessageType
	{
		 ...
		 * @param repeat         If the requirement will be rechecked every time this
		 *                       message is reached
	...
	public static class MerchantGuiMessage extends MessageType
	{
		...
		public ITextComponent getMessage(EntityConsort consort, EntityPlayer player, String chainIdentifier)
		{
			...
			player.openGui(Minestuck.instance, MinestuckGuiHandler.GuiId.MERCHANT.ordinal(), player.world, (int) consort.posX, (int) consort.posY, (int) consort.posZ);
