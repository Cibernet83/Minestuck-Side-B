...
{
	public static final ResourceLocation MS_ICONS = new ResourceLocation(Minestuck.MODID, "textures/gui/icons.png");
	...
	{
		return new ResourceLocation(Minestuck.MODID, "textures/gui/captcha_cards.png");
	}
