...
import com.mraof.minestuck.network.message.MessageDataCheckerRequest;
...
public class GuiDataChecker extends GuiScreen
{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
	{
		...
		if (guiComponent != null)
		{
			...
			mc.fontRenderer.drawString("Retrieving data from server...", xOffset + 9, yOffset + 15 - mc.fontRenderer.FONT_HEIGHT / 2, 0);
	...
	protected void actionPerformed(GuiButton button) throws IOException
	{
		...
		{
			MinestuckNetwork.sendToServer(new MessageDataCheckerRequest());
