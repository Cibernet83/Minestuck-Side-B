...
public class CruxiteSlimeRenderer extends RenderLiving<EntityCruxiteSlime>
{
	private static final ResourceLocation SLIME_TEXTURES = new ResourceLocation(Minestuck.MODID, "textures/entity/cruxite_slime.png");
