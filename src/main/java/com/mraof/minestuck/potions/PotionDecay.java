...
public class PotionDecay extends MSPotionBase
{
	...
	{
		if (!(event.getType() == RenderGameOverlayEvent.ElementType.HEALTH && Minecraft.getMinecraft().player.isPotionActive(MinestuckPotions.DECAY)))
			return;
