...
public class PotionBerserk extends MSPotionBase
{
	...
	protected PotionBerserk(String name, boolean isBadEffectIn, int liquidColorIn)
	{
	...
	public void performEffect(EntityLivingBase entityLivingBaseIn, int amplifier)
	{
		if (entityLivingBaseIn instanceof EntityPlayer)
		{
			...
			if (stats.getFoodLevel() <= 0)
			{
				...
				entityLivingBaseIn.removeActivePotionEffect(MinestuckPotions.RAGE_BERSERK);
