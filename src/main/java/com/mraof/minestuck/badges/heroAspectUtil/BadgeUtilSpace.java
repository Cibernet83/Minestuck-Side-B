	...
	public boolean onBadgeTick(World world, EntityPlayer player, IBadgeEffects badgeEffects, GodKeyStates.KeyState state, int time)
	{
		...
		if (state == GodKeyStates.KeyState.RELEASED)
		{
			...
			if (time >= 20)
				...
				badgeEffects.startPowerParticles(BadgeUtilSpace.class, MinestuckParticles.ParticleType.AURA, EnumAspect.SPACE, 5);
		}
		else
			badgeEffects.startPowerParticles(BadgeUtilSpace.class, MinestuckParticles.ParticleType.AURA, EnumAspect.SPACE, (time >= 20 && pos1 != null && pos2 != null) ? 6 : 1);
