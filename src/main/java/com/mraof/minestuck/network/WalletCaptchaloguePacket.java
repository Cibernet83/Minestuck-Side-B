...
public class WalletCaptchaloguePacket extends MinestuckPacket
{
    int entity;
    BlockPos pos;
    ...
    public void execute(EntityPlayer player)
    {
        ...
        if(entity != null)
        {
            ItemStack stack = new ItemStack(MinestuckItems.walletEntityItem);
            ItemWalletEntity.storeEntity(entity, stack);
