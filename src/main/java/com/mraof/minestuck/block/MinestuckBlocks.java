...
public class MinestuckBlocks
{
	...
	public static final MSBlockBase gristBlockAmber = new BlockGrist(MinestuckGrists.amber);
	public static final MSBlockBase gristBlockAmethyst = new BlockGrist(MinestuckGrists.amethyst);
	public static final MSBlockBase gristBlockArtifact = new BlockGrist(MinestuckGrists.artifact);
	public static final MSBlockBase gristBlockBuild = new BlockGrist(MinestuckGrists.build);
	public static final MSBlockBase gristBlockCaulk = new BlockGrist(MinestuckGrists.caulk);
	public static final MSBlockBase gristBlockChalk = new BlockGrist(MinestuckGrists.chalk);
	public static final MSBlockBase gristBlockCobalt = new BlockGrist(MinestuckGrists.cobalt);
	public static final MSBlockBase gristBlockDiamond = new BlockGrist(MinestuckGrists.diamond);
	public static final MSBlockBase gristBlockGarnet = new BlockGrist(MinestuckGrists.garnet);
	public static final MSBlockBase gristBlockGold = new BlockGrist(MinestuckGrists.gold);
	public static final MSBlockBase gristBlockIodine = new BlockGrist(MinestuckGrists.iodine);
	public static final MSBlockBase gristBlockMarble = new BlockGrist(MinestuckGrists.marble);
	public static final MSBlockBase gristBlockMercury = new BlockGrist(MinestuckGrists.mercury);
	public static final MSBlockBase gristBlockQuartz = new BlockGrist(MinestuckGrists.quartz);
	public static final MSBlockBase gristBlockRuby = new BlockGrist(MinestuckGrists.ruby);
	public static final MSBlockBase gristBlockRust = new BlockGrist(MinestuckGrists.rust);
	public static final MSBlockBase gristBlockShale = new BlockGrist(MinestuckGrists.shale);
	public static final MSBlockBase gristBlockSulfur = new BlockGrist(MinestuckGrists.sulfur);
	public static final MSBlockBase gristBlockTar = new BlockGrist(MinestuckGrists.tar);
	public static final MSBlockBase gristBlockUranium = new BlockGrist(MinestuckGrists.uranium);
	public static final MSBlockBase gristBlockZillium = new BlockGrist(MinestuckGrists.zillium);
	public static final MSBlockBase gristBlockVis = new BlockGrist(MinestuckGrists.vis);
	public static final MSBlockBase gristBlockMana = new BlockGrist(MinestuckGrists.mana);
