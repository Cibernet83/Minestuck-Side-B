...
{
	public static final PropertyEnum<BlockGlowystoneWire.EnumAttachPosition> NORTH = PropertyEnum.create("north", BlockGlowystoneWire.EnumAttachPosition.class);
	public static final PropertyEnum<BlockGlowystoneWire.EnumAttachPosition> EAST = PropertyEnum.create("east", BlockGlowystoneWire.EnumAttachPosition.class);
	public static final PropertyEnum<BlockGlowystoneWire.EnumAttachPosition> SOUTH = PropertyEnum.create("south", BlockGlowystoneWire.EnumAttachPosition.class);
	public static final PropertyEnum<BlockGlowystoneWire.EnumAttachPosition> WEST = PropertyEnum.create("west", BlockGlowystoneWire.EnumAttachPosition.class);
	...
	private boolean isPowerSourceAt(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
	{
		...
		return !flag1 && flag && canConnectUpwardsTo(worldIn, blockpos.up()) || (canConnectTo(iblockstate, side, worldIn, pos) || (!flag && canConnectUpwardsTo(worldIn, blockpos.down())));
	}
	...
	public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand)
	{
		...
		worldIn.spawnParticle(EnumParticleTypes.REDSTONE, d0, d1, d2, 1.0, 0.8, 0);
	}
