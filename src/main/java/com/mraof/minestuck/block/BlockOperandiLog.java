...
public class BlockOperandiLog extends BlockOperandi
{
	public static final PropertyEnum<EnumFacing.Axis> AXIS = PropertyEnum.<EnumFacing.Axis>create("axis", EnumFacing.Axis.class);
	
	public BlockOperandiLog(String name, float hardness, float resistance, Material blockMaterialIn, String toolClass)
	{
