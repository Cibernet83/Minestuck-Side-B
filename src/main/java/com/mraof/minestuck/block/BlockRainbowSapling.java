...
public class BlockRainbowSapling extends BlockBush implements IGrowable, IRegistryBlock
{
	...
	{
		return new BlockStateContainer(this, GROWN_SOME, RED, GREEN, BLUE);
	}

	private void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
	{
		if (worldIn.isRemote || !net.minecraftforge.event.terraingen.TerrainGen.saplingGrowTree(worldIn, rand, pos))
			return;
