...
import com.cibernet.fetchmodiplus.client.gui.captchalogue.ChatGuiHandler;
...
public class ChatModus extends BaseModus
{
	...
	public void handleChatSend(String msg)
	{
		...
		{
			player.world.playSound(null, player.getPosition(), FMPSounds.chatModusPing, SoundCategory.PLAYERS, 0.8f, 1);
