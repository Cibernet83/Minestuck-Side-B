...
public class CruxiteSlimeEntity extends EntityTameable
{
	
	private static final DataParameter<Integer> SLIME_SIZE = EntityDataManager.createKey(CruxiteSlimeEntity.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> SLIME_COLOR = EntityDataManager.createKey(CruxiteSlimeEntity.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> CRUXITE_TYPE = EntityDataManager.createKey(CruxiteSlimeEntity.class, DataSerializers.VARINT);
	private static final DataParameter<ItemStack> STORED_ITEM = EntityDataManager.createKey(CruxiteSlimeEntity.class, DataSerializers.ITEM_STACK);
	...
	public CruxiteSlimeEntity(World worldIn)
	{
		super(worldIn);
	...
	{
		EntityLiving.registerFixesMob(fixer, CruxiteSlimeEntity.class);
	}
			...
			for(EntityItem item : world.getEntitiesWithinAABB(EntityItem.class, itemBB))
			{
				...
				if(isSlimeFood(stack))
				{
					...
					else
					{
						...
						{
							if(!world.isRemote)
								InventoryHelper.spawnItemStack(world, posX, posY, posZ, new ItemStack(FMPItems.cruxiteGel, 1, getCruxiteType()));
						}
	...
	protected CruxiteSlimeEntity createInstance()
	{
		return new CruxiteSlimeEntity(this.world);
	}
	...
	public void setDead()
	{
		...
		if (!this.world.isRemote && i > 1 && this.getHealth() <= 0.0F)
		{
			...
			for (int k = 0; k < j; ++k)
			{
				...
				CruxiteSlimeEntity entityslime = this.createInstance();
	...
	{
		private final CruxiteSlimeEntity slime;
		private int growTieredTimer;
		
		public AISlimeAttack(CruxiteSlimeEntity slimeIn)
		{
			this.slime = slimeIn;
			this.setMutexBits(2);
		}
	...
	static class AISlimeFace extends EntityAIBase
	{
		...
		public AISlimeFace(CruxiteSlimeEntity slimeIn)
		{
			this.slime = slimeIn;
			this.setMutexBits(2);
		}
	...
	static class AISlimeFloat extends EntityAIBase
	{
		...
		public AISlimeFloat(CruxiteSlimeEntity slimeIn)
		{
			this.slime = slimeIn;
			this.setMutexBits(5);
	...
	static class AISlimeHop extends EntityAIBase
	{
		...
		public AISlimeHop(CruxiteSlimeEntity slimeIn)
		{
			this.slime = slimeIn;
			this.setMutexBits(5);
		}
	...
	static class SlimeMoveHelper extends EntityMoveHelper
	{
		...
		public SlimeMoveHelper(CruxiteSlimeEntity slimeIn)
		{
			super(slimeIn);
			this.slime = slimeIn;
