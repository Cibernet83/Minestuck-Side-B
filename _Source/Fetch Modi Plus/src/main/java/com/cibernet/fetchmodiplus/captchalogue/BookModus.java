...
import com.cibernet.fetchmodiplus.client.gui.captchalogue.BookGuiHandler;
...
public class BookModus extends BaseModus
{
	...
	public ItemStack createBook()
	{
		...
		ItemStack book = new ItemStack(FMPItems.captchalogueBook, 1, MinestuckPlayerData.getData(player).color+1);
	...
	{
		if(stack.getItem().equals(FMPItems.captchalogueBook))
		{
