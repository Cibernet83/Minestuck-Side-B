...
public abstract class BaseModusGuiHandler extends SylladexGuiHandler
{
	...
	public static final ResourceLocation EXTRAS = new ResourceLocation(FetchModiPlus.MODID, "textures/gui/icons.png");
	...
	{
		return new ResourceLocation(FetchModiPlus.MODID, "textures/gui/captcha_cards.png");
	}
