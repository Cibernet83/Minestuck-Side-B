...
import com.cibernet.minestuckgodtier.entities.ai.EntityAIFollowHope;
import com.cibernet.minestuckgodtier.entities.ai.EntityAIHopeHurtByTarget;
import com.cibernet.minestuckgodtier.entities.ai.EntityAIHopeHurtTarget;
...
public class EntityHopeGolem extends EntityIronGolem
{
	...
	public void onAddedToWorld()
	{
		...
		getCapability(MSGTCapabilities.BADGE_EFFECTS, null).oneshotPowerParticles(MSGTParticles.ParticleType.AURA, EnumAspect.HOPE, 20);
	}
	...
	public void onLivingUpdate()
	{
		...
		if(!world.isRemote)
		{
			...
			if(getHopeTicks() < 0)
			{
				getCapability(MSGTCapabilities.BADGE_EFFECTS, null).oneshotPowerParticles(MSGTParticles.ParticleType.BURST, EnumAspect.HOPE, 20);
				setDead();
			}
