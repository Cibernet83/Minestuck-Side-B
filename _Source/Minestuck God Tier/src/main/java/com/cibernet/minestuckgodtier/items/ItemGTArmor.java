...
import com.cibernet.minestuckgodtier.client.models.armor.ModelGTAbstract;
import com.cibernet.minestuckgodtier.util.MSGTArmorModels;
...
public class ItemGTArmor extends ItemArmor
{

	public ItemGTArmor(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) 
	{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) 
	{
		...
		return MinestuckGodTier.MODID + ":textures/models/armor/gt_" + heroClass.toString() + ".png";
	}
