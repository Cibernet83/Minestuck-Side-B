...
public class BlockSpectralHeroStone extends Block implements IGodTierBlock
{
	...
	public BlockSpectralHeroStone(EnumAspect aspect)
	{
		...
		setUnlocalizedName("heroStoneSpectral");
		setRegistryName("spectral_hero_stone" + (aspect == null ? "" : ("_" + aspect.toString())));
	...
	{
		if(entityIn instanceof EntityPlayer && entityIn.getCapability(MSGTCapabilities.GOD_TIER_DATA, null).isGodTier()
