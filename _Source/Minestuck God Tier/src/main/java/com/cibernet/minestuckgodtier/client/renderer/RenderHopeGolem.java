package com.cibernet.minestuckgodtier.client.renderer;

import com.cibernet.minestuckgodtier.MinestuckGodTier;
import com.cibernet.minestuckgodtier.client.layers.LayerHopeGolemFlower;
import com.cibernet.minestuckgodtier.client.layers.LayerHopeGolemSkin;
...
{
	private static final ResourceLocation TEXTURE = new ResourceLocation(MinestuckGodTier.MODID, "textures/entity/hope_golem.png");
	private static final ResourceLocation ANGRY_TEXTURE = new ResourceLocation(MinestuckGodTier.MODID, "textures/entity/hope_golem_enraged.png");
