...
public class PotionConceal extends MSGTPotionBase
{
	...
	{
		if(event.getEntity().getCapability(MSGTCapabilities.BADGE_EFFECTS, null).isConcealed())
		{
	...
	public void applyAttributesModifiersToEntity(EntityLivingBase entityLivingBaseIn, AbstractAttributeMap attributeMapIn, int amplifier)
	{
		...
		entityLivingBaseIn.getCapability(MSGTCapabilities.BADGE_EFFECTS, null).setConcealed(true);
	}
	...
	public void removeAttributesModifiersFromEntity(EntityLivingBase entityLivingBaseIn, AbstractAttributeMap attributeMapIn, int amplifier)
	{
		...
		entityLivingBaseIn.getCapability(MSGTCapabilities.BADGE_EFFECTS, null).setConcealed(false);
