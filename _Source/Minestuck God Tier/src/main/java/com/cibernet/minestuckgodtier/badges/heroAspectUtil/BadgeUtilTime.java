...
public class BadgeUtilTime extends BadgeHeroAspectUtil
{
	...
	{
		if (Badge.findItem(player, new ItemStack(MSGTItems.heroStoneShards.get(EnumAspect.TIME), 128), false) &&
			Badge.findItem(player, new ItemStack(Items.CLOCK, 100), false))
		{
			Badge.findItem(player, new ItemStack(MSGTItems.heroStoneShards.get(EnumAspect.TIME), 128), true);
