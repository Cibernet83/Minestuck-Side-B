...
public class EntityLocatorEye extends Entity
{
	...
	public EntityLocatorEye(World worldIn)
	{
		super(worldIn);
	...
	public void onUpdate()
	{
		...
		if (!this.world.isRemote)
		{
			...
			if (this.despawnTimer > 80 && !this.world.isRemote)
			{
				...
				{
					ItemStack stack = new ItemStack(MSGTItems.denizenEye);
	...
	public void handleStatusUpdate(byte id)
	{
		...
		if(id == 0)
			world.spawnParticle(EnumParticleTypes.ITEM_CRACK, posX, posY, posZ, world.rand.nextGaussian() * 0.15D, world.rand.nextDouble() * 0.2D, world.rand.nextGaussian() * 0.15D, Item.getIdFromItem(MSGTItems.denizenEye));
