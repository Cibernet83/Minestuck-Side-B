...
public class ItemKit extends Item
{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) 
	{
		...
		Item[] armor = new Item[] {MSGTItems.gtHood, MSGTItems.gtShirt, MSGTItems.gtPants, MSGTItems.gtShoes};
		for(Item i : armor)
		{
	...
	{
		ItemStack stack = new ItemStack(MSGTItems.armorKit);
	...
	{
		return MinestuckPlayerData.getTitle(sburbConnection.getClientIdentifier()) != null && sburbConnection.getClientIdentifier().getPlayer().getCapability(MSGTCapabilities.GOD_TIER_DATA, null).isGodTier();
	}
