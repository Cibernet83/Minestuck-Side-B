...
public class Badge extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<Badge> implements Comparable<Badge>
{
    ...
    public boolean canUse(World world, EntityPlayer player) { return !(player.isPotionActive(MSGTPotions.GOD_TIER_LOCK) && player.getActivePotionEffect(MSGTPotions.GOD_TIER_LOCK).getAmplifier() >= 2); }
