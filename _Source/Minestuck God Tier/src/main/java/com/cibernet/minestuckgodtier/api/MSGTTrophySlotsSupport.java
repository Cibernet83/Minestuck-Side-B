package com.cibernet.minestuckgodtier.api;
...
public class MSGTTrophySlotsSupport
{
	@SubscribeEvent
	...
	protected static void updateSlots(EntityPlayer player, boolean sendMessage)
	{
		...
		if(player.getCapability(MSGTCapabilities.GOD_TIER_DATA, null).isBadgeActive(MSGTBadges.PATCH_OF_THE_HOARDER))
