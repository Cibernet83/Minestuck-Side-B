package com.cibernet.minestuckgodtier.client.particles;
	...
	public static void spawnAuraParticles(World world, double x, double y, double z, int color, int count)
	{
		if(world.isRemote)
			for (int i = 0; i < count; i++)
			{
				...
				MSGTParticles.spawnPowerParticle(world, x+off.x, y+off.y, z+off.z, vel.x, vel.y, vel.z, world.rand.nextInt(10)+10, color);
			}
	}
