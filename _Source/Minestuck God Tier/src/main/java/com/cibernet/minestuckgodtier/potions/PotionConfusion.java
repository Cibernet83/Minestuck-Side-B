...
public class PotionConfusion extends PotionMouseSensitivityAdjusterBase
{
	...
	{
		if (Minecraft.getMinecraft().player != null && Minecraft.getMinecraft().player.isPotionActive(MSGTPotions.MIND_CONFUSION) && event.getGui() instanceof GuiOptions)
	...
	{
		if (event.getEntityLiving().isPotionActive(MSGTPotions.MIND_CONFUSION))
		{
