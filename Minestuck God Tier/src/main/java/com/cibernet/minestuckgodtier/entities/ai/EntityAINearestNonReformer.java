package com.cibernet.minestuckgodtier.entities.ai;
...
public class EntityAINearestNonReformer extends EntityAINearestAttackableTargetWithHeight
{
	...
	{
		return super.isSuitableTarget(target, includeInvincibles) && (target == null || !target.getCapability(MSGTCapabilities.BADGE_EFFECTS, null).isReforming());
	}
}
