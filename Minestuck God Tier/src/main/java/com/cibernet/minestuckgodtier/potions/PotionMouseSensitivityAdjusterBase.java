...
public abstract class PotionMouseSensitivityAdjusterBase extends MSGTPotionBase
{
	...
	public void setMouseSensitivity(EntityLivingBase entityLivingBase)
	{
		if (entityLivingBase.world.isRemote)
			...
			if (entityLivingBase instanceof EntityPlayer)
				MSGTChannelHandler.sendToPlayer(MSGTPacket.makePacket(MSGTPacket.Type.SET_MOUSE_SENSITIVITY, getIdFromPotion(this)), (EntityPlayer) entityLivingBase);
	}
	...
	public static void resetMouseSensitivity(EntityLivingBase entityLivingBase)
	{
		if (entityLivingBase.world.isRemote)
			...
			if (entityLivingBase instanceof EntityPlayer)
				MSGTChannelHandler.sendToPlayer(MSGTPacket.makePacket(MSGTPacket.Type.SET_MOUSE_SENSITIVITY, -1), (EntityPlayer) entityLivingBase);
	}
