...
public class PotionComeback extends MSGTPotionBase
{
    ...
    public static void onLivingDamage(LivingHurtEvent event)
    {
        ...
        if (entity.isPotionActive(MSGTPotions.GOD_TIER_COMEBACK) && event.getSource() != DamageSource.OUT_OF_WORLD)
            event.setAmount(event.getAmount() * (float)(25-((entity.getActivePotionEffect(MSGTPotions.GOD_TIER_COMEBACK).getAmplifier() + 1) * 5)) / 25f);
    }
}
