...
public class GodKeyStates implements IGodKeyStates
{
	...
	{
		if(event.getEntity().hasCapability(MSGTCapabilities.GOD_KEY_STATES, null))
			event.getEntity().getCapability(MSGTCapabilities.GOD_KEY_STATES, null).resetKeyStates();
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event)
	{
		...
		IBadgeEffects badgeEffects = event.player.getCapability(MSGTCapabilities.BADGE_EFFECTS, null);
		IGodKeyStates keyStates = event.player.getCapability(MSGTCapabilities.GOD_KEY_STATES, null);
