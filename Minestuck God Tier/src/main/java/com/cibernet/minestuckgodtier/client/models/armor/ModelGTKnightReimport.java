package com.cibernet.minestuckgodtier.client.models.armor;// Made with Blockbench
...
public class ModelGTKnightReimport extends ModelBiped
{
	...
	public ModelGTKnightReimport()
	{
		...
		head.cubeList.add(new ModelBox(head, 50, 9, -5.0F, -9.0F, -5.0F, 10, 8, 1, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 0, 0, -5.0F, -1.0F, -5.0F, 10, 1, 10, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 32, 3, -5.0F, -9.0F, -4.0F, 1, 8, 8, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 0, 11, -5.0F, -10.0F, -4.0F, 10, 1, 8, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 16, 52, -4.0F, -10.0F, 4.0F, 8, 1, 1, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 34, 50, -4.0F, -10.0F, -5.0F, 8, 1, 1, 0.0F, false));
