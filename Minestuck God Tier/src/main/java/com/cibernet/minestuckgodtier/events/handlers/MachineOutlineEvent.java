...
public class MachineOutlineEvent
{
	...
	public static void renderWorld(RenderWorldLastEvent event)
	{
		...
		if (mc.player != null && mc.getRenderViewEntity() == mc.player)
		{
			...
			if (mc.player.isSneaking() && mc.player.getCapability(MSGTCapabilities.GOD_TIER_DATA, null).isBadgeActive(MSGTBadges.BADGE_UTIL_SPACE) && state.getBlock() instanceof BlockSburbMachine)
			{
