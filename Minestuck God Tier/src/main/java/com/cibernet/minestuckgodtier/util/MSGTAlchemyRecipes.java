...
public class MSGTAlchemyRecipes
{
	public static void registerRecipes()
	{
		...
		CombinationRegistry.addCombination("chiseled_hero_stone", new ItemStack(MinestuckUniverseItems.knittingNeedles), false, CombinationRegistry.Mode.MODE_OR, new ItemStack(MSGTItems.sashKit));
		...
		CombinationRegistry.addCombination("chiseled_hero_stone", new ItemStack(MinestuckUniverseItems.ironMedallion), false, CombinationRegistry.Mode.MODE_AND, new ItemStack(MSGTItems.skillReseter));
