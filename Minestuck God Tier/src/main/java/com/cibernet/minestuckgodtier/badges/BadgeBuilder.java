...
public class BadgeBuilder extends BadgeLevel
{
	...
	public static void onClientTick(TickEvent.ClientTickEvent event)
	{
		...
		} else if (isDragging)
		{
			if (cap.getEditPos1() != null)
			{
				MSGTChannelHandler.sendToServer(MSGTPacket.makePacket(MSGTPacket.Type.EDIT_FILL_BLOCKS, cap.getEditPos1(), cap.getEditPos2(), cap.getEditTraceHit(), cap.getEditTraceFacing()));
			}
			cap.setEditPos1(null);
			cap.setEditPos2(null);
		}
	...
	{return (ClientEditHandler.isActive() || (player.getCapability(MSGTCapabilities.GOD_TIER_DATA, null) != null && player.getCapability(MSGTCapabilities.GOD_TIER_DATA, null).isBadgeActive(MSGTBadges.BUILDER_BADGE)))
