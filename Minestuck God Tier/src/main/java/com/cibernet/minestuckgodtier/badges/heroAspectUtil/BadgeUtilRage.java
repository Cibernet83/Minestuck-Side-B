...
import com.cibernet.minestuckgodtier.entities.ai.EntityAIAttackRageShifted;
...
public class BadgeUtilRage extends BadgeHeroAspectUtil
{
	...
	public boolean onBadgeTick(World world, EntityPlayer player, IBadgeEffects badgeEffects, GodKeyStates.KeyState state, int time)
	{
		...
		if(time == 1)
		{
			...
			target.getCapability(MSGTCapabilities.BADGE_EFFECTS, null).oneshotPowerParticles(MSGTParticles.ParticleType.AURA, EnumAspect.RAGE, 10);
	...
	{
		IBadgeEffects badgeEffects = entity.getCapability(MSGTCapabilities.BADGE_EFFECTS, null);
	...
	public static void enableRageShift(EntityCreature entity)
	{
		...
		entity.getCapability(MSGTCapabilities.BADGE_EFFECTS, null).cleanRageShift();
	}
	...
	public static void onLivingUpdate(LivingEvent.LivingUpdateEvent event)
	{
		...
		if (event.getEntityLiving().getCapability(MSGTCapabilities.BADGE_EFFECTS, null).isRageShiftDirty())
